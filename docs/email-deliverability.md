...
This app sends verification and password-reset emails through Supabase Auth.
...
4. If your Supabase project supports custom email sending/domain settings, enable it and add the DNS records shown by Supabase.
